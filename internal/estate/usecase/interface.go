...
type EstateUsecase interface {
	GetEstateDronePlan(ctx context.Context, estateID uuid.UUID, params generated.GetEstateDronePlanParams) (result *generated.GetEstateDronePlanResponse, err error)
